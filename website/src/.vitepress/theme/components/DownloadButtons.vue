...
const downloadInformation = computed(() => ({
  ...
  stable: {
    ...
    asset: (release.stable.assets ?? [])
      .find(a => /^Komikku-v\d+\.\d+\.\d+.apk/.test(a.name)),
  },
}))
  ...
  <div>
    ...
    <div v-if="!isAndroid" class="custom-block warning">
      ...
      <p>
        ...
        <strong>Komikku</strong> is not affiliated with this project.
      </p>
      <blockquote>
    ...
    <div class="download-buttons">
      ...
      >
        <IconBugReport />
        <span class="text">Komikku Beta</span>
