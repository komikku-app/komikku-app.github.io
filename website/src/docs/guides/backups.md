...
Backups in **Komikku** are compatible between different versions of the app.
...
::: tip
To convert your backups to JSON or to view and edit the information outside of the app, you can use [Komikku Backup Viewer](https://github.com/Animeboynz/Mihon-Backup-Viewer).
:::
...
You can transfer downloaded series chapters from one version of **Komikku** to another
...
Cross device sync in **Komikku** is not currently available, but users can use
