...
1. **Restart Komikku**: Force close and reopen the app.
...
## Personalized issue
If you're the only one facing a problem, you might be encountering [Cloudflare](/docs/guides/troubleshooting/#cloudflare) protection, an IP ban, or other countermeasures set by website owners against programs like **Komikku**.
...
1. Check [open issues](https://github.com/komikku-app/komikku/issues).
2. Check [closed issues](https://github.com/komikku-app/komikku/issues?q=is%3Aissue+is%3Aclosed) in case it's resolved but not yet released.
